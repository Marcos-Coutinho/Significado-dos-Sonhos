function kw_list ()
					...
					document.writeln("<div class='asd' style='height:468px;'>");
					...
					{
					document.writeln("<div style='text-align:left; padding-left:15px; padding-right:15px;'>");
						document.writeln (
							'<A HREF="' + this.url + '">' + this.title + '</A> ' + this.description + '<br>'
						);
					document.writeln("</div>");
					}
