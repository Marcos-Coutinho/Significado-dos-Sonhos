function kw_list ()
					...
					document.writeln("<div class='asd'>");					
					...
					the_entries[0] = new entry ("http://www.google.com.br", "WebMaster Leandro Eber Ribeio", "leandro, autor, webmaster, dono, desenvolvedor, contatos, icq, contato, parcerias ", "Saiba um ab pouco sobre o WebMaster deste site, ICQ, E-mail, Contatos, Cargos, História da HP e muito mais.<br>");
					
					the_entries[1] = new entry ("http://www.google.com.br","Brazil<br>","brazil, desenhos, ikki, IkkiNet, IkkiNET, SSJ_Clan, SSJ, afiliados, aliados, amigos, afilia-se","Saiba um ab pouco sobre o WebMaster deste site, ICQ, E-mail, Contatos, Cargos, História da HP e muito mais.<br>");
					
					the_entries[2] = new entry ("http://www.google.com.br","Brazil","brazil, desenhos, ikki, IkkiNet, IkkiNET, SSJ_Clan, SSJ, afiliados, aliados, amigos, afilia-se","<br>");
					
					the_entries[3] = new entry ("http://www.google.com.br","Brazil","brazil, desenhos, ikki, IkkiNet, IkkiNET, SSJ_Clan, SSJ, afiliados, aliados, amigos, afilia-se","<br>");
					
					the_entries[4] = new entry ("http://www.google.com.br","Brazil","brazil, desenhos, ikki, IkkiNet, IkkiNET, SSJ_Clan, SSJ, afiliados, aliados, amigos, afilia-se","<br>");
					
					
					//abaixo vai o número de entradas existentes
					
					var entry_num = 5; //aumenta de acordo com as obcoes de busca no caso 2 ate agora
					
					var max_keywords = 20; //aumenta de acordo com as obcoes de busca no caso 2 ate agora
					
					var points_title = 5; //aumenta de acordo com as obcoes de busca no caso 2 ate agora
					
					var points_keywords = 5; //aumenta de acordo com as obcoes de busca no caso 2 ate agora
